  ...
  experience: [
    {
      ...
      summary: "Reports to the CTO. Owns architecture, implementation, and technical direction across core platform initiatives - designing and building the systems directly while setting the standards the team executes against.",
      bullets: [
        ...
        "Replaced legacy processor prone to OOM failures with no horizontal scaling with cloud function architectures personally written in Python and Golang, eliminating idle infrastructure cost and enabling on-demand scaling across a platform serving 60M+ monthly shoppers and 65k+ retail partners.",
        ...
        "Built the API service layer for a proprietary trained LLM-based taxonomy classification system, replacing manual human classification of every new UPC entering the system with instant automated classification driven by product data attributes.",
        ...
        "Led technical execution for Retail Campaign Studio (2023) and Storefronts (2024), two major platform launches extending self-service advertising and retail presence capabilities to 65k+ retail partners and 1,000s of brands reaching 60M+ monthly shoppers.",
        "Set technical direction for 20+ engineers through architecture reviews, API and integration design standards, and data modeling; owned security, compliance, performance, and scalability review processes - defining the acceptance criteria and guardrails the full team builds against.",
      ],
    },
    {
      ...
      summary:
        "CTO and primary engineer at a bootstrapped call center platform - responsible for all technical decisions, system architecture, infrastructure, and hands-on delivery from concept to production.",
      bullets: [
        ...
        "Designed and built a custom DSL for call flow orchestration, cutting script buildout and deployment from 30+ days to hours - enabling non-technical users to design and modify call flows at runtime with built-in A/B testing and staged rollout, all without code deployments.",
        "Designed and built EZTPV, a hybrid web and call center verification system that became a core product offering; the resulting hybrid model reduced the company's call center footprint from 3 facilities to 1 by shifting the majority of verification workflows to automated web-based processing.",
    ...
    },
    {
      ...
      bullets: [
        "Invented and developed a containerized appliance solution for enterprise software lifecycle management, reducing customer setup time from days to minutes and eliminating manual configuration errors across diverse enterprise environments.",
        "Architected a unified deployment platform for standardized application lifecycle management, enabling consistent, repeatable deployments across multiple environments and cloud platforms.",
        "Designed an extensible plugin architecture supporting multiple container orchestration and cloud platforms.",
    ...
    },
    {
      ...
      bullets: [
        "Personally drove pre-sales engagements, on-site enterprise training, and proof-of-concept implementations across 20+ Fortune 500 and government clients - directly contributing to customer acquisition that fueled growth from Series A through acquisition by Dell.",
